...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" style="height: 10px;width: 10px;" href="../assets/images/logo 1.png" type="image/png">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn" type="button" style="background-color: rgba(0, 108, 187, 1);color: white;">
