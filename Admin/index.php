...
$sqlTotalAppointments = "SELECT COUNT(*) AS total_appointments FROM patients";
$sqlTotalDoctors = "SELECT COUNT(*) AS total_doctors FROM doctors";
$sqlTotalPatients = "SELECT COUNT(*) AS total_patients FROM users";

$resultAppointments = $conn->query($sqlTotalAppointments);
$resultDoctors = $conn->query($sqlTotalDoctors);
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Welcome, <?php echo $admin_name ?></span>
