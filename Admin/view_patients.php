            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">View Patients</h1>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            // echo "<a href='#' class='btn btn-icon btn-success'><i class='fas fa-edit'></i></a> ";
                                            // echo "<a href='#' class='btn btn-icon btn-danger' onclick=\"return confirm('Are you sure you want to delete this record?')\"><i class='fas fa-trash'></i></a>";
                                            echo "</td>";
                                            echo "</tr>";
                                            $sn++;
                                        }
