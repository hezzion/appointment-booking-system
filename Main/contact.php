...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 13:15:47 GMT -->
<head>
        <meta charset="utf-8" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="card features feature-primary text-center border-0">
                            <div class="icon text-center rounded-md mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16" style="color: rgba(0, 108, 187, 1);">
                            ...
                            <div class="card-body p-0 mt-3">
                                ...
                                <a href="tel:+234-903-5279-803" class="link">+234-903-5279-803</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="card features feature-primary text-center border-0">
                            <div class="icon text-center rounded-md mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16" style="color: rgba(0, 108, 187, 1);">
                            ...
                            <div class="card-body p-0 mt-3">
                                <h5>Email</h5>
                                <p class="text-muted mt-3">Great doctor if you need your family member to get effective assistance</p>
                                <a href="mailto:zakijonathan3@gmail.com" class="link">zakijonathan3@gmail.com</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0 pt-2 pt-lg-0">
                        <div class="card features feature-primary text-center border-0">
                            <div class="icon text-center rounded-md mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16" style="color: rgba(0, 108, 187, 1);">
...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 13:15:48 GMT -->
</html>