...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 13:15:16 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Zion</title>
                            ...
                            <div class="card-body">
                                ...
                                <form class="login-form mt-4">
                                    <div class="row">
                                        ...
                                        <div class="mx-auto">
                                            <p class="mb-0 mt-3"><small class="text-dark me-2">Remember your password ?</small> <a href="login.php" class="text-dark h6 mb-0">Sign in</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
