...
<head>
    ...
    <body style="font-family: 'Arimo', sans-serif;" >
            ...
            <div class="container">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-left">
                        ...
                        <li class="#">
                            <a href="login.php">Login</a><span class="menu-arrow"></span>

                        </li>
                        <li class="#">
                            <a href="signup.php">Signup</a><span class="menu-arrow"></span>
                ...
                <div class="row mt-5 mt-sm-0 align-items-center">
                    <div class="col-md-6">
                        <div class="heading-title">
                            <h1 class="heading mb-4"> <span style="color: rgba(0, 108, 187, 1);font-family: 'Dancing Script', cursive;">Revolutionizing Healthcare Access,</span>
                                Your Future of Hassle-Free Appointments.</h1>
                            <p class="para-desc text-muted mb-0">Introducing our advanced health appointment app, redefining healthcare management. With a focus on innovation and excellence, we prioritize your well-being at every step</p>
                        </div>
                        <div class="mt-4 pt-2">
                            <a href="signup.php" class="btn btn" style="background-color: rgba(0, 108, 187, 1);color: white;">Join Us</a>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-eye-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-5 mt-sm-0">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-psychotherapy-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-5 mt-lg-0">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-stethoscope-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-5 mt-xl-0">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-capsule-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-microscope-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-pulse-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-empathize-fill h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                            <div class="card features feature-primary border-0">
                                <div class="icon text-center rounded-md">
                                    <i class="ri-mind-map h3 mb-0" style="color: rgba(0, 108, 187, 1)"></i>
                                </div>
                                <div class="card-body p-0 mt-3">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="section-title me-lg-5">
                            <span class="badge rounded-pill bg-soft"style="color: rgba(0, 108, 187, 1)">About Doctris</span>
        ...
        <!-- Cta Start -->
        <section class="section" style="background: url('../assets/images/bg/01.jpg') center center;">
            <div class="bg-overlay bg-overlay-dark" style="opacity: 0.9;"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 offset-lg-7 col-md-7 offset-md-5">
                        <div class="features feature-bg-primary d-flex card flex-row p-4 rounded-md shadow position-relative overflow-hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16" style="color: rgba(0, 108, 187, 1)">
                        ...
                        <div class="features feature-bg-primary d-flex card flex-row p-4 rounded-md shadow position-relative overflow-hidden mt-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-eyeglasses" viewBox="0 0 16 16" style="color: rgba(0, 108, 187, 1)">
                        ...
                        <div class="features feature-bg-primary d-flex card flex-row p-4 rounded-md shadow position-relative overflow-hidden mt-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-patch-question" viewBox="0 0 16 16" style="color: rgba(0, 108, 187, 1)">
        ...
        <!-- Back to top -->
        <a href="#" onclick="topFunction()" id="back-to-top" class="back-to-top fs-5 rounded-pill text-center bg justify-content-center align-items-center" style="background-color: rgba(0, 108, 187, 1);color:white ;"><i data-feather="arrow-up" class="fea icon-sm"></i></a>
        <!-- Back to top -->
                                ...
                                <div class="subcribe-form mt-4">
                                    <form>
                                        <div class="mb-0">
                                            ...
                                            <button type="submit" class="btn btn-pills btn" style="background-color: rgba(0, 108, 187, 1);color: white;">Search</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
